...
function listReply(){
	$.ajax({
	   ...
	   success: function(result){
	       console.log(result);
	       var output = "<table border='0' width='100%' align='center' style='background:#F6F6F6;border-bottom:solid 1px #D2D2D2;'>";
	       for(var i in result){
...
function addReply(refmm,textlvlmm,stepmm,parentsnomm){
	var rep = "";
	rep += "<table id='tb_replyMain' width='100%' align='center' border='0'>";
	rep += "<tr><td>";
	...
	rep += "<textarea rows='3' id='contentM' placeholder='내용' style='margin-top:2px;resize:none;width:100%;'></textarea>";
		...
		<ons-card>
			...
			<div class="content">
				<ons-list>
					...
					<ons-list-item><div style='background:#F6F6F6;width:100%;min-height: 100px;'>${view.content}</div></ons-list-item>
					<ons-list-foot>
