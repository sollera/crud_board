...
import com.crud.hib.User;
import com.crud.hib.UserHibernateProviderImpl;
import com.crud.hib.UserProvider;
...
public class HomeController {
	...
	public String list(@PathVariable String pgNo,Model model) throws Exception{
		...
		//hibernate 방식 select list
		provider = new UserHibernateProviderImpl();
		List<User> postsList2 = provider.selectList(firstPost);
		model.addAttribute("postList", postsList2);
